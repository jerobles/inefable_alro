...
0.2. **Carrito de compras (2026-09-05).** Antes solo se podía pedir un producto por vez: tres velas distintas eran tres formularios, tres pagos y **tres domicilios**. Por módulos, como siempre:
   ...
   - **Carrito-3b (pendiente)** — retirar el formulario viejo de producto único (`FormPedido.astro`) de las páginas de producto. Se dejó a propósito como red de seguridad mientras se prueba el carrito en producción; quitarlo cuando el carrito esté confirmado.
